...
public interface Inverter_Repository extends JpaRepository<Inverter_Table_Model, Integer> {
    ...
    // avg_pv_voltage, avg_output_voltage, avg_output_current]
    ...
    // that ISO week so padded and real buckets share the same map key.
    ...
    // Monthly buckets: bucket_label is "yyyy-MM"
