...
class AddDevicesBottomSheet extends StatelessWidget {
  const AddDevicesBottomSheet({super.key});
        ...
        children: [
          ...
          const Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  "Open WI-Fi List in Mobile Device and Connect with Inverter Wi-Fi (BatteryLess Inverter)",
