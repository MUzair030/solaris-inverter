...
import 'MultiLineChartWidget1.dart';

class buildHistoryInverterCard extends StatefulWidget {
  final List<GeyserHistoryResponseModel> dataoverall;
  final String energydata;
  final String endate;
  final String entime;
  final GeyserHistoryResponseModel data;
  final String date;
  final String time;
  ...
  const buildHistoryInverterCard({
    Key? key,
  ...
  @override
  State<buildHistoryInverterCard> createState() => _buildInverterCardState();
}

class _buildInverterCardState extends State<buildHistoryInverterCard> {
  ...
  Widget build(BuildContext context) {
    final viewModel = context.watch<GeyserHistoryViewModel>();
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text.rich(
                                        TextSpan(
                                          text: viewModel.errorTypeMessage ??
                                              'Loading...',
                                          style: const TextStyle(
                                            fontSize: 16,
