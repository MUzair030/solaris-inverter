...
class MultiLineChartWidget1 extends StatelessWidget {
  final List<GeyserHistoryResponseModel> dataoverall;

  const MultiLineChartWidget1({Key? key, required this.dataoverall})
      : super(key: key);
    ...
    return Column(
      children: [
        SizedBox(
          ...
          child: LineChart(_buildLineChart(dataoverall)),
        ),
        const SizedBox(height: 10),
        _buildLegend(dataoverall),
      ],
    );
  }

  LineChartData _buildLineChart(List<GeyserHistoryResponseModel> inverterData) {
    ...
    // Group data by hour
    final Map<int, List<GeyserHistoryResponseModel>> hourlyData = {};
    ...
    return LineChartData(
      ...
      maxX: latestHour.toDouble(),
      minY: 0,
      // maxY: 5000,
      lineBarsData: [
        _buildLineChartBarData(energySpots, const Color(0xFF2277BB), "Units Consumed"),
          ...
          getTooltipItems: (touchedSpots) {
            return touchedSpots.map((spot) {
              ...
              if (index >= 0 && hourToDateTime.containsKey(index)) {
                ...
                dateTime = DateFormat('MMM:dd:yy-hh:mm').format(date);
              } else {
                dateTime = "N/A";
              }
  ...
  LineChartBarData _buildLineChartBarData(
    ...
    List<FlSpot> powerSpots = dataoverall
        .asMap()
        .entries
  ...
  Widget _buildLegend(List<GeyserHistoryResponseModel> inverterData) {
    final latest =
    ...
    return Padding(
      ...
      child: Wrap(
        ...
        children: [
          ...
          _legendItem(const Color(0xFF2277BB), "Power", "${latest.genPower} KW"),
